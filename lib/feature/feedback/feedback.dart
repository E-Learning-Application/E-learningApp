...
class _FeedbackScreenState extends State<FeedbackScreen>
  ...
  Future<void> _loadFeedbacks() async {
    ...
    try {
      // Simulate API call - GET /api/feedback/all
      ...
      setState(() {
        feedbacks = [
          Feedback(
              ...
              userId: 2,
              rating: 4.5,
              comment: "Great platform with lots of useful features!",
      ...
      _showErrorSnackbar('Failed to load feedbacks');
    } finally {
  ...
  Future<void> _createFeedback() async {
    ...
    try {
      ...
      _showErrorSnackbar('Failed to create feedback');
    } finally {
      setState(() => isLoading = false);
    }
  }
  ...
  Future<void> _updateFeedback(
    ...
    setState(() => isLoading = true);
    try {
      // Simulate API call - PUT /api/feedback
      ...
      _showErrorSnackbar('Failed to update feedback');
    } finally {
      setState(() => isLoading = false);
    }
  }
  ...
  Future<void> _deleteFeedback(int feedbackId) async {
    setState(() => isLoading = true);
    try {
      // Simulate API call - DELETE /api/feedback
      await Future.delayed(Duration(milliseconds: 400));

      setState(() {
        feedbacks.removeWhere((f) => f.id == feedbackId);
      });

      _showSuccessSnackbar('Feedback deleted successfully!');
    } catch (e) {
      _showErrorSnackbar('Failed to delete feedback');
    } finally {
      setState(() => isLoading = false);
    }
  }
            ...
            child: Column(
              ...
              children: [
                ...
                ...List.generate(5, (index) {
                  ...
                  final percentage = feedbacks.isEmpty
                      ? 0.0
  ...
  void _showEditDialog(Feedback feedback) {
...
class FeedbackApiService {
  ...
  static Future<List<Feedback>> getAllFeedbacks(int userId) async {
    // Implementation for GET /api/feedback/all?userId={userId}
    // Add your HTTP client logic here
    throw UnimplementedError('Implement HTTP client');
  }

  static Future<Feedback> createFeedback(double rating, String comment) async {
    // Implementation for POST /api/feedback/
    // Add your HTTP client logic here
    throw UnimplementedError('Implement HTTP client');
  }

  static Future<Feedback> updateFeedback(
      int id, double rating, String comment) async {
    // Implementation for PUT /api/feedback
    // Add your HTTP client logic here
    throw UnimplementedError('Implement HTTP client');
  }

  static Future<void> deleteFeedback(int feedbackId) async {
    // Implementation for DELETE /api/feedback?feedbackId={feedbackId}
    // Add your HTTP client logic here
    throw UnimplementedError('Implement HTTP client');
  }
}
